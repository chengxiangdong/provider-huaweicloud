...
type vpc_subnetInitParameters struct {
...
type vpc_subnetObservation struct {
...
type vpc_subnetParameters struct {
...
// vpc_subnetSpec defines the desired state of vpc_subnet
type vpc_subnetSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     vpc_subnetParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider vpc_subnetInitParameters `json:"initProvider,omitempty"`
}

// vpc_subnetStatus defines the observed state of vpc_subnet.
type vpc_subnetStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        vpc_subnetObservation `json:"atProvider,omitempty"`
}
...
type vpc_subnet struct {
	...
	Spec   vpc_subnetSpec   `json:"spec"`
	Status vpc_subnetStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// vpc_subnetList contains a list of vpc_subnets
type vpc_subnetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []vpc_subnet `json:"items"`
}

// Repository type metadata.
var (
	vpc_subnet_Kind             = "vpc_subnet"
	vpc_subnet_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: vpc_subnet_Kind}.String()
	vpc_subnet_KindAPIVersion   = vpc_subnet_Kind + "." + CRDGroupVersion.String()
	vpc_subnet_GroupVersionKind = CRDGroupVersion.WithKind(vpc_subnet_Kind)
)

func init() {
	SchemeBuilder.Register(&vpc_subnet{}, &vpc_subnetList{})
}
