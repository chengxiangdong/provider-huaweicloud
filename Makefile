# ====================================================================================
# Setup Project
PROJECT_NAME := provider-huaweicloud
PROJECT_REPO := github.com/chengxiangdong/$(PROJECT_NAME)
...
IMAGES = provider-huaweicloud
-include build/makelib/imagelight.mk

# ====================================================================================
# Setup XPKG

XPKG_REG_ORGS ?= xpkg.upbound.io/chengxiangdong
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/chengxiangdong
XPKGS = provider-huaweicloud
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-huaweicloud: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider huaweicloud CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider huaweicloud controllers
...
# This target prepares repo for your provider by replacing all "huaweicloud"
